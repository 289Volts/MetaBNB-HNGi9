...
function place(props) {
	...
	return (
		<div className="place-container p-4 space-y-3 text-[0.89rem] border-2 shadow-md rounded-[14px]">
			<div className="place-img relative">
				<img src={props.img} alt="" className="w-full" />
				<div className="heart absolute top-[7%] right-[7%]" onClick={() => setIsFavourite((prevState) => !prevState)}>
					<svg width="24" height="24" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							...
							fill={isFavourite ? "red" : "#D7D7D7"}
							stroke={isFavourite ? "red" : "url(#paint0_linear_5163_349)"}
						/>
						<defs>
							<linearGradient
			...
			<div className="star">
				<img src="../src/assets/Frame 59528.svg" alt="" className="stars w-[30%]" />
			</div>
		</div>
	);
}
