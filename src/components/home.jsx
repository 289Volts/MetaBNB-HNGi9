...
const Home = () => {
  ...
  return (
		<div className="main-container text-center md:text-left">
			<section className="hero-section flex flex-col gap-7 pb-7 md:pb-[4.1875rem] md:flex-row md:items-center md:justify-between md:w-[90%] md:mx-auto lg:w-[87%] xl:w-[80%]">
				<div className="r-side px-4 flex flex-col gap-4 md:w-[54%] md:px-0 lg:gap-[3rem] lg:w-[60%] xl:w-[48%]">
					...
					<div className="input-field flex md:justify-start md:w-[92%] xl:w-[85%]">
						...
						/>
						<button className="bg-meta text-white py-[0.4rem] w-[35%] rounded-tr-[4px] rounded-br-[4px]">Search</button>
					</div>
				</div>
